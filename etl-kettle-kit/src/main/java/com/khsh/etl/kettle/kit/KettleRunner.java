package com.khsh.etl.kettle.kit;// package com.khsh.etl.kettle.kit;
//
...
//      *  执行job
//      */
//     public static boolean run(Map<String,String> initKettleParam, String dbuuid, String storageType, String ktlJobType, String repositoryDir, String fileName) throws KettleException {
